 ...
 *    @param {string} params.user -required -
 *                                possible values: will depend on loginMode (a validate email so far, based on emailAndPassword loginMode)
